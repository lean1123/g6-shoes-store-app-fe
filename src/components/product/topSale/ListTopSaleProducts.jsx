    ...
    <div className="topSale-container " >
      ...
      <div className="flex mt-4">
        <div className="w-1/5 bg-gray-200 ml-5 bg-white">
          ...
          <div className="search-container bg-white flex flex-col items-start" style={scrollStyles}>
          ...
          <div className="flex justify-between">
            ...
            <div className=" search-container mr-3">
              <select className="w-full border no-border py-1 px-10 input-field font-bold">
                <option value="banChay" className="font-bold">Bán chạy</option>
                <option value="moiNhat" className="font-bold">Mới nhất</option>
              </select>
            </div>
          </div>
